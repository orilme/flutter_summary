...
import 'dart:ui';
import 'package:flutter_demo/widget/listView_separated_page.dart';
...
class Header extends StatelessWidget {
  ...
  Header(this.title, {this.color= Colors.red, this.offset = 0});
